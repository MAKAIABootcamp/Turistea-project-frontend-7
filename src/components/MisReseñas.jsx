      ...
      <div className="flex">
        ...
        <div className="w-3/4 ml-8">
          <div className="mb-4" style={{ color: "#4CAF50" }}>
            ...
            <div className="mx-auto mt-2 w-90 h-[2px] bg-primary-line mb-6"></div>{" "}
            {/* Línea azul debajo del título */}
          </div>
          {/* Cartagena */}
          <div
            className="w-[878px] h-[306px] mt-6 bg-white p-6 shadow rounded mb-4"
            style={{ color: "#4CAF50" }}
          >
            {/* Título encima de la imagen */}
            <h1 className="text-2xl font-body mb-4">Cartagena</h1>{" "}
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex-1 ml-4 p-3" style={{ color: "#4CAF50" }}>
                ...
                <p className="text-gray-600 font-body mb-4">
                  {" "}
                  {/* Aumentado el margen inferior */}
                  Descubre la encantadora Cartagena, un destino lleno de
                  historia, color y sabor caribeño. ¡Déjate seducir por su
                  magia!
                </p>
          ...
          {/* Casanare */}
          <div className=" mt-6 w-[878px] h-[306px] bg-white p-6 shadow rounded mb-4">
            <h1
              className="text-2xl font-body mb-4"
              style={{ color: "#4CAF50" }}
            >
              Casanare
            </h1>{" "}
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex-1 ml-4 p-3">
                <h2
                  className="text-xl font-body flex justify-between items-center mb-2"
                  style={{ color: "#4CAF50" }}
                >
                  Casanare
                  <div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex-1 ml-4 p-3">
                ...
                <p className="text-gray-600">
                  ...
                  impresionantes, cascadas que te quitan el aliento y una
                  cultura súper rica. Puedes recorrer pueblitos pintorescos,
                  perderte en la naturaleza de sus parques y probar platillos
                  deliciosos.
                </p>
                <div className="w-90 h-8 bg-white py-2 px-4 rounded-full shadow flex items-center justify-between mb-4">
                  <span style={{ color: "#4CAF50" }}>Hospedaje</span>
