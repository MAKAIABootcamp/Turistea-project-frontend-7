...
const DetailsPost = () => {
  return (
    ...
    <div>
    <h1 className="font-poppins text-24 font-bold text-gray-800 ml-20">Experiencia Relajante En Hotel Caribe</h1>
  ...
  <svg
    ...
    >
      <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="Icon-Set" transform="translate(-312.000000, -726.000000)" fill="#ffa317">
